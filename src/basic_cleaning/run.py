...
def go(args):
    ...
    logger.info("Save clean data to file and upload to W&B")
    clean_data_name = "clean_sample.csv"
    ...
    artifact.add_file(clean_data_name)
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="A simple basic data cleaning"
    )

    parser.add_argument(
        "--input_artifact",
        type=str,
        help="Full name of the artifact",
        required=True,
    )
    ...
    parser.add_argument(
        "--output_artifact",
        type=str,
        help="Output name of the artifact",
        required=True,
    )
